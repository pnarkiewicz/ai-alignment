...
from train.online_dpo_config import OnlineDPOConfig
...
from train.impl import SmoothedOnlineDPOTrainer
...
class IterativeOnlineDirectPreferenceTrainer:
    ...
    def step(self, epoch: int, epoch_size: int):
        ...
        trainer = SmoothedOnlineDPOTrainer(**dpo_train_args)
    ...
    def generate_one_round_samples(self, idx: int):
        ...
        internal_model = llm_class(
            alias=IterativeOnlineDirectPreferenceTrainer.DEFAULT_DEBATER_ALIAS,
            file_path=None,
            is_debater=True,
        )
