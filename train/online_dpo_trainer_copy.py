...
from train.impl import SmoothedOnlineDPOTrainerV2
...
class IterativeDirectPreferenceTrainerV2:
    ...
    def step(self, epoch: int, epoch_size: int):
        ...
        trainer = SmoothedOnlineDPOTrainerV2(**dpo_train_args)
    ...
    def generate_one_round_samples(self, idx: int):
        ...
        internal_model = llm_class(
            alias=IterativeDirectPreferenceTrainerV2.DEFAULT_DEBATER_ALIAS,
            file_path=None,
            is_debater=True,
        )
