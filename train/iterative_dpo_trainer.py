...
from data import JudgePreferencesDataset, JudgePreferencesLoader, RawDataset, RewardType, SplitType
...
from utils import logger_utils, LoggingCallback
from utils.constants import DEBUG
import utils.constants as constants

try:
    from utils.flash_attn_utils import upcast_layer_for_flash_attention
...
class IterativeDirectPreferenceTrainer:
    ...
    def step(self, epoch: int, epoch_size: int):
        ...
        training_args = TrainingArguments(
            ...
            save_strategy=("no" if self.config.training_hyperparameters.steps > 1 and self.config.training_hyperparameters.num_train_epochs == 1 else "steps"),
            ...
            max_steps=(
                ...
                if self.config.training_hyperparameters.lr_scheduler_type == "constant"
                    ...
                    // (self.config.training_hyperparameters.per_device_train_batch_size * self.config.training_hyperparameters.gradient_accumulation_steps)
                )
            ),
