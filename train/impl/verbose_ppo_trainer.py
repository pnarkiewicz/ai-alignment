...
from accelerate.utils import gather_object, is_deepspeed_available, ProjectConfiguration
import datasets
...
from transformers import DataCollatorForLanguageModeling, PreTrainedTokenizer, PreTrainedTokenizerBase, PreTrainedTokenizerFast
...
from trl.models import create_reference_model, PreTrainedModelWrapper, SUPPORTED_ARCHITECTURES, unwrap_model_for_generation
...
class VerbosePPOTrainer(BaseTrainer):
    """
    ...
    def generate(
        ...
        **generation_kwargs,
        ...
        if isinstance(query_tensor, List):
            ...
            if generate_ref_response:
                with unwrap_model_for_generation(ref_model, self.accelerator, is_peft_model=self.is_peft_model) as unwrapped_model:
