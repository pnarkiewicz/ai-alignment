...
from train import (
    IterativeOnlineDirectPreferenceTrainer,
    TrainUtils,
    IterativeDirectPreferenceTrainerV2,
)

args = ScriptUtils.get_args()
script_config = ScriptUtils.get_training_run_script_config(
    args, train_type=TrainType.ONLINE_DPO
)
...
trainer = IterativeDirectPreferenceTrainerV2(
